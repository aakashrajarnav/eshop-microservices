namespace Ordering.Infrastructure.Data.Extensions
{
    internal class InitialData
    {
        ...
        new List<Customer>
        {
            Customer.Create(CustomerId.Of(new Guid("58c49479-ec65-4de2-86e7-033c546291aa")), "aakash", "aakashrajarnav@gmail.com"),
            Customer.Create(CustomerId.Of(new Guid("189dc8dc-990f-48e0-a37b-e6f2b60b9d7d")), "arnav", "arnav@gmail.com")
        };
        ...
        public static IEnumerable<Order> OrdersWithItems
        {
            get
            {
                var address1 = Address.Of("aakash", "raj", "aakashrajarnav@gmail.com", "ITC Cox Town", "Bangalore", "India", "560005");
                var address2 = Address.Of("arnav", "kumar", "arnav@gmail.com", "Bramhpura Road No 1", "Muzaffarpur", "India", "842003");

                var payment1 = Payment.Of("aakash", "5555555555554444", "12/28", "355", 1);
                var payment2 = Payment.Of("arnav", "8885555555554444", "06/30", "222", 2);
